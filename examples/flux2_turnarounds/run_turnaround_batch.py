...
with open(os.path.join(OUTPUT_DIR, 'turnaround_front.json')) as f:
...
views = [
    {
        ...
        "prefix": "Flux2-Turnaround-ThreeQuarterFront"
    },
    {
        "name": "SideProfile",
        "seed": 7382910463,
        ...
        "prefix": "Flux2-Turnaround-SideProfile"
    },
    {
        ...
        "prefix": "Flux2-Turnaround-ThreeQuarterBack"
    },
    {
        "name": "Back",
        "seed": 4738291056,
...
for view in views:
    ...
    # Save workflow JSON
    wf_path = os.path.join(OUTPUT_DIR, f'turnaround_{view["name"]}.json')
    ...
    # Wait a moment between submissions to let them queue
    time.sleep(2)

print(f'\nAll {len(results)} views submitted. Polling for completion...')
